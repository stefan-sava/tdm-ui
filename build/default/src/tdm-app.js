          ...
          <app-toolbar id="mainToolbar">
            <div class="navItem leftItem">
              ...
              <a href="#[[sectionData.section]]" tabindex="-1">
                <paper-icon-button icon="arrow-back" alt="Back to the home"></paper-icon-button></a>
            </div>
            <div class="spacer">
              <h1>Totul despre motociclism</h1>
            </div>
          </app-toolbar>
...
`,
  ...
  properties: {
    sections: {
      type: Array,
      value: function () {
        return ['home', 'categoria am', 'categoria a1', 'categoria a2', 'categoria a'];
      }
    },
    selectedTab: {
      type: Number,
